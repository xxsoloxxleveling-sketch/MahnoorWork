    ...
    <div className="relative w-full h-full flex flex-col items-center justify-center bg-cover bg-center border-r border-slate-200/50 overflow-hidden" style={{ backgroundImage: "url('/cute_robot_background.png')" }}>
      ...
      {showChat && (
        <div className="absolute bottom-6 w-[90%] z-20 flex flex-col gap-3">
          {/* Suggestions */}
          <div className="flex gap-2 overflow-x-auto no-scrollbar scroll-smooth w-full px-2 py-1 justify-start md:justify-center">
             <button type="button" onClick={() => onChatAction?.("Change color to blue")} className="whitespace-nowrap px-3 py-1.5 bg-white/95 backdrop-blur-md rounded-full text-[11px] font-bold text-slate-700 border border-white/50 shadow-sm hover:shadow-md hover:text-primary hover:border-primary/30 transition-all cursor-pointer">✨ Blue</button>
             <button type="button" onClick={() => onChatAction?.("Change color to orange")} className="whitespace-nowrap px-3 py-1.5 bg-white/95 backdrop-blur-md rounded-full text-[11px] font-bold text-slate-700 border border-white/50 shadow-sm hover:shadow-md hover:text-primary hover:border-primary/30 transition-all cursor-pointer">✨ Orange</button>
             <button type="button" onClick={() => onChatAction?.("Change color to purple")} className="whitespace-nowrap px-3 py-1.5 bg-white/95 backdrop-blur-md rounded-full text-[11px] font-bold text-slate-700 border border-white/50 shadow-sm hover:shadow-md hover:text-primary hover:border-primary/30 transition-all cursor-pointer">✨ Purple</button>
             <button type="button" onClick={() => onChatAction?.("Change color to pink")} className="whitespace-nowrap px-3 py-1.5 bg-white/95 backdrop-blur-md rounded-full text-[11px] font-bold text-slate-700 border border-white/50 shadow-sm hover:shadow-md hover:text-primary hover:border-primary/30 transition-all cursor-pointer">✨ Pink</button>
             <button type="button" onClick={() => onChatAction?.("Change color to teal")} className="whitespace-nowrap px-3 py-1.5 bg-white/95 backdrop-blur-md rounded-full text-[11px] font-bold text-slate-700 border border-white/50 shadow-sm hover:shadow-md hover:text-primary hover:border-primary/30 transition-all cursor-pointer">✨ Teal</button>
             <button type="button" onClick={() => onChatAction?.("Change website name")} className="whitespace-nowrap px-3 py-1.5 bg-white/95 backdrop-blur-md rounded-full text-[11px] font-bold text-slate-700 border border-white/50 shadow-sm hover:shadow-md hover:text-primary hover:border-primary/30 transition-all cursor-pointer">✨ Change Name</button>
             <button type="button" onClick={() => onChatAction?.("Enable dark mode")} className="whitespace-nowrap px-3 py-1.5 bg-white/95 backdrop-blur-md rounded-full text-[11px] font-bold text-slate-700 border border-white/50 shadow-sm hover:shadow-md hover:text-primary hover:border-primary/30 transition-all cursor-pointer">✨ Dark Mode</button>
             <button type="button" onClick={() => onChatAction?.("Enable light mode")} className="whitespace-nowrap px-3 py-1.5 bg-white/95 backdrop-blur-md rounded-full text-[11px] font-bold text-slate-700 border border-white/50 shadow-sm hover:shadow-md hover:text-primary hover:border-primary/30 transition-all cursor-pointer">✨ Light Mode</button>
          </div>
